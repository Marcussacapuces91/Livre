...
def analyze(variables: dict, struct: dict, n: int = 0, path=None) -> str | None:
    ...
    def generate(current_path, title, guidance, prolog) -> str:
        ...
        console.print( table(title, my_llm.last_response) )
    ...
    def rec(variables: dict, struct: dict, n: int, path: list) -> str:
        ...
        resp = (
            generate(current_path, title, guidance, prolog)
